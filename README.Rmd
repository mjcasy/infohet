...
Package for the quantification of the information content of single-cell RNA-sequencing data-sets, and how much of this information has been captured by clustering. Based on the quantification of information in heterogeneity (infohet).
...
Visualise gene-wise information - the amount of information gain from knowing the cellular allocation of transcripts for each gene.
...
Generate set of clusters, e.g. from Seurat pipeline, ranging over hyperparameter of interest, e.g. resolution.
...
load("../Entropy/maximum_entropy/Figures/TianClus")
```

Elbow Plot of total information explained by clustering against resolution hyperparameter and cluster number

```{r, echo = FALSE}
plot(Elbow[,1], Elbow[,3], ylab = "Total Information Explained", xlab = "Number of Clusters", type = "l")
plot(Elbow[,2], Elbow[,3], ylab = "Total Information Explained", xlab = "Number of Clusters", type = "l")
```
