...
```{r, include = FALSE}
load("../Entropy/TimeSeries/Analysis/TianTCElbow")
```

```{r, echo = FALSE}
plot(Elbow[,1], Elbow[,3], ylab = "Net Information Explained", xlab = "Resolution", type = "l")
```

```{r, echo = FALSE}
plot(Elbow[,2], Elbow[,3], ylab = "Net Information Explained", xlab = "Number of Clusters", type = "l")
abline(v = 3, col = "red")
```
